 ...
 * @author Brett Kriz
 */
public class List<E> implements Iterable<E>  { //implements Referenceable
        protected E[] elems;
	...
	public List() {
        ...
        public List(E[] list){
            // Make list with known table
            // HOWEVER, check for nulls when adding
	...
	public void add(E e) {
        ...
        public Object[] getArrayObjectCopy(){
            E[] ans1 = resize(elems,size);
            Object[] ans = ((Object[])ans1);
            return ans;
        }
        ...
        public Iterator<E> iterator() {
            ...
            Iterator<E> ans = new Iterator<E>(){
                ...
                public boolean hasNext(){
                    return curIndex < size && elems[curIndex] != null;
                }
                public E next(){
