...
public class Heap<K extends Comparable<K>,V> extends PriorityQueueBase<K,V> implements MaxPriorityQueue<K,V>  {
	...
	public Heap() {
            ...
            tree = new CompleteTree< Entry<K,V> >(this.backing);
	}
	...
	public Entry<K,V> insert(K key, V value) throws InvalidKeyException {
            ...
            int i = this.size();// o(1)
            // Add and track
            ArrayDNode t2 = this.tree.addLast2(t); // Epected cost O(1), despite possible resizes
            t2.setIndex( i );
            t.index = i;
            // TCJ: The cost of everything above this comment is o(1)
            // but when we call bubble up, it costs o(Log n)

            // Put into place and go
	...
	public Entry<K,V> removeMax() throws EmptyPriorityQueueException {
            // TCJ: the removal happens at Log N time due to bubbledown,
            // everything else runs at constant
