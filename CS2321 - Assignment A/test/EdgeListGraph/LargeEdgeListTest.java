...
@jug.SuiteName("LargeEdgeListTest")
public class LargeEdgeListTest {
	...
	public void setup() throws Throwable {
		TARGET = ( EdgeListGraph<RoomCoordinate, Walkway> )( new Labyrinth( "LargeLabyrinth.txt" ).setupLabyrinth( "LargeLabyrinth.txt" ) );
	}
