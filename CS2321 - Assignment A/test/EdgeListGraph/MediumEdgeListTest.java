...
@jug.SuiteName("MediumEdgeListTest")
public class MediumEdgeListTest {
	...
	public void setup() throws Throwable {
		TARGET = ( EdgeListGraph<RoomCoordinate, Walkway> )( new Labyrinth( "MediumLabyrinth.txt" ).setupLabyrinth( "MediumLabyrinth.txt" ) );
	}
