...
@jug.SuiteName("SmallEdgeListTest")
public class SmallEdgeListTest {
	...
	public void setup() throws Throwable {
		TARGET = ( EdgeListGraph<RoomCoordinate, Walkway> )( new Labyrinth( "SmallLabyrinth.txt" ).setupLabyrinth( "SmallLabyrinth.txt" ) );
	}
