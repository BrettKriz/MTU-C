...
@jug.SuiteName("LargeAdjListTest")
public class LargeAdjListTest {
	...
	public void setup() throws Throwable {
		TARGET = ( AdjListGraph<RoomCoordinate, Walkway> )( new Labyrinth( "LargeLabyrinth.txt" ).setupLabyrinth( "LargeLabyrinth.txt" ) );
	}
