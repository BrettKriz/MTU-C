...
@jug.SuiteName("MediumAdjMatrixTest")
public class MediumAdjMatrixTest {
	...
	public void setup() throws Throwable {
		TARGET = ( AdjMatrixGraph<RoomCoordinate, Walkway> )( new Labyrinth( "MediumLabyrinth.txt" ).setupLabyrinth( "MediumLabyrinth.txt" ) );
	}
