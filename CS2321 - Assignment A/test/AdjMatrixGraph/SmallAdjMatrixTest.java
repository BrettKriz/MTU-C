...
@jug.SuiteName("SmallAdjMatrixTest")
public class SmallAdjMatrixTest {
	...
	public void setup() throws Throwable {
		TARGET = ( AdjMatrixGraph<RoomCoordinate, Walkway> )( new Labyrinth( "SmallLabyrinth.txt" ).setupLabyrinth( "SmallLabyrinth.txt" ) );
	}
