...
@jug.SuiteName("TinyAdjMatrixTest")
public class TinyAdjMatrixTest {
	...
	public void Test1() throws Throwable {
		TARGET = ( AdjMatrixGraph<RoomCoordinate, Walkway> )( new Labyrinth( "TinyLabyrinth.txt" ).setupLabyrinth( "TinyLabyrinth.txt" ) );
